...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/styleAgendamiento.css">
    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
    <script src="../../assets/js/agendamiento/Especialidades.js"></script>
    <script src="../../assets/js/agendamiento/Tratamientos.js"></script>
    <script src="../../assets/js/agendamiento/Profesional.js"></script>
